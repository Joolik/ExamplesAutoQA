...
public class TestData {
    ...
    private static final String PATH_DATA_FILES = "src/test/resources/";
    private static final String PATH_ATTACHMENT = "src/test/resources/attachments/";
